...
import { FaCloud, FaPuzzlePiece, FaShieldAlt, FaUsers } from "react-icons/fa";
...
export default function WhyChooseUs() {
  const features = [
    ...
    },
    {
      ...
      description:
        ...
        icon: <FaPuzzlePiece  className="text-blue-500 text-xl" />
    },
    {
  ...
  return (
    <section className="bg-white py-10 px-4 lg:px-7 ">
